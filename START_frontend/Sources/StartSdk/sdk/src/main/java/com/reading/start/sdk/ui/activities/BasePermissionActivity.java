...
import com.reading.start.sdk.AppPermissions;
import com.reading.start.sdk.R;
import com.reading.start.sdk.general.SdkLog;
import com.reading.start.sdk.ui.UiConstants;
    ...
    private void showPermissionErrorDialog() {
        runOnUiThread(() -> {
            try {
                ...
                SdkLog.e(TAG, "showPermissionErrorDialog", e);
            }
        });
    }
    ...
    private void showPermissionDeniedErrorDialog() {
        runOnUiThread(() -> {
            try {
                ...
                SdkLog.e(TAG, "showPermissionDeniedErrorDialog", e);
            }
        });
    }
