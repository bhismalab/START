...
public class Preferences {
    ...
    private static final String s_preference_sync_time = "sync_time_eye_tracking";
    private static final long s_preference_sync_time_default = 0;

    private static final String s_preference_sync_time_in_progress = "sync_time_eye_tracking_in_progress";
