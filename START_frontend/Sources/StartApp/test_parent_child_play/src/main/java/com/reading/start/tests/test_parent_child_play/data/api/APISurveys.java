package com.reading.start.tests.test_parent_child_play.data.api;
...
public interface APISurveys {
    @GET("api/assestments/parent_child_play")
    ...
    @GET("api/surveys/{survey_id}/results/parent_child_play")
    Call<ResponseDownloadSurveyResultData> getResult(@Header("X-Auth-Token") String token,
                                                     @Path("survey_id") String surveyId);

    @GET("api/surveys/{survey_id}/attachments/parent_child_play")
