...
@RealmClass
public class ParentChildPlayTestSurveyResult extends RealmObject {
    public static final String FILED_ID = "id";
    public static final String FILED_ID_SERVER = "idServer";
    public static final String FILED_ID_ATTACHMENT_SERVER = "idAttachmentServer";
    ...
    @SerializedName(FILED_ID_ATTACHMENT_SERVER)
    private int idAttachmentServer = -1;
    ...
    public ParentChildPlayTestSurveyResult() {
    }

    public ParentChildPlayTestSurveyResult(int id, int surveyId, String testRefTable,
                                           String testRefId, String resultFiles,
    ...
    public int getIdAttachmentServer() {
        return idAttachmentServer;
    }

    public void setIdAttachmentServer(int idAttachmentServer) {
        this.idAttachmentServer = idAttachmentServer;
    }
