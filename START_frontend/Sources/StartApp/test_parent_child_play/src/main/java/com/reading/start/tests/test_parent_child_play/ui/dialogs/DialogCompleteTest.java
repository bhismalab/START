package com.reading.start.tests.test_parent_child_play.ui.dialogs;
...
public class DialogCompleteTest extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View mRootView = inflater.inflate(R.layout.test_parent_child_play_dialog_completed_test, container);
