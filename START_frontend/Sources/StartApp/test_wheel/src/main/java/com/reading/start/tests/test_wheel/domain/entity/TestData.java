...
public class TestData {
    ...
    public static final String FILED_STIMULUS_ITEMS = "stimulus_items";
    ...
    @SerializedName(FILED_STIMULUS_ITEMS)
    private ArrayList<TestDataStimulus> mStimulusItems = null;
    ...
    public ArrayList<TestDataStimulus> getStimulusItems() {
        return mStimulusItems;
    }

    public void setStimulusItems(ArrayList<TestDataStimulus> stimulusItems) {
        mStimulusItems = stimulusItems;
    }
