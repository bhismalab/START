...
@RealmClass
public class ColoringTestSurveyResult extends RealmObject {
    ...
    public ColoringTestSurveyResult() {
    }

    public ColoringTestSurveyResult(int id, int surveyId, String testRefTable, String testRefId, String resultFiles,
