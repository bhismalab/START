package com.reading.start.tests.test_coloring.data.api;
...
public interface APISurveys {
    ...
    @GET("api/surveys/{survey_id}/results/coloring")
    Call<ResponseDownloadSurveyResultData> getResult(@Header("X-Auth-Token") String token,
                                                     @Path("survey_id") String surveyId);

    @GET("api/surveys/{survey_id}/attachments/coloring")
