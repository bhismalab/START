...
/**
 * Dialog for displaying error when synchronize.
 */
public class DialogSynchronizeError extends DialogFragment {
    ...
    public static DialogSynchronizeError getInstance(String title, String message, DialogListener listener) {
        DialogSynchronizeError frag = new DialogSynchronizeError();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View mRootView = inflater.inflate(R.layout.dialog_synchronize_error, container);
        mRootView.findViewById(R.id.button_try_again).setOnClickListener(v -> {
            dismiss();
