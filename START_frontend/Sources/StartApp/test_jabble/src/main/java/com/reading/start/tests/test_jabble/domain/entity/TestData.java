...
public class TestData {
    ...
    public static final String FILED_BUBBLES_PROPPED = "bubblesPopped";
    public static final String FILED_BUBBLES_TOTAL = "bubblesTotal";
    ...
    @SerializedName(FILED_BUBBLES_PROPPED)
    private int mBubblesPopped = 0;

    @SerializedName(FILED_BUBBLES_TOTAL)
    private int mBubblesTotal = 0;
    ...
    public int getBubblesPopped() {
        return mBubblesPopped;
    }

    public void setBubblesPopped(int bubblesPopped) {
        mBubblesPopped = bubblesPopped;
    }

    public int getBubblesTotal() {
        return mBubblesTotal;
    }

    public void setBubblesTotal(int bubblesTotal) {
        mBubblesTotal = bubblesTotal;
    }
