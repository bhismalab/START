package com.reading.start.tests.test_jabble.ui.views;
...
public class CompleteTriggerView extends View {
    ...
    public interface CompleteTriggerViewListener {
        ...
        void onTouchChanged(float x, float y, float touchPressure, float touchSize);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mListener != null) {
            mListener.onTouchChanged(mCurrentX, mCurrentY, mCurrentTouchPressure, mCurrentTouchSize);
