...
@RealmClass
public class MotorFollowingTestSurveyAttachments extends RealmObject {
    ...
    public MotorFollowingTestSurveyAttachments() {
    }

    public MotorFollowingTestSurveyAttachments(int id, int surveyId, String attachmentFile) {
        this.id = id;
