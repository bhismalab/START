...
@RealmClass
public class MotorFollowingTestSurveyResult extends RealmObject {
    ...
    public MotorFollowingTestSurveyResult() {
    }

    public MotorFollowingTestSurveyResult(int id, int surveyId, String testRefTable, String testRefId, String resultFiles,
