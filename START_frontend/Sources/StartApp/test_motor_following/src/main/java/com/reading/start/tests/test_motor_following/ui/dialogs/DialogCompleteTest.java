package com.reading.start.tests.test_motor_following.ui.dialogs;
...
public class DialogCompleteTest extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View mRootView = inflater.inflate(R.layout.test_motor_following_dialog_completed_test, container);
