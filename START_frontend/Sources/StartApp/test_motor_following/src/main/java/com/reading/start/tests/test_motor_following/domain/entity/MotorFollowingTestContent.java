...
@RealmClass
public class MotorFollowingTestContent extends RealmObject {
    ...
    public MotorFollowingTestContent() {
    }

    public MotorFollowingTestContent(String id, String name, String img1, String img2, String img3,
