...
@RealmClass
public class ParentTestSurveyResult extends RealmObject {
    ...
    public ParentTestSurveyResult() {
    }

    public ParentTestSurveyResult(int id, int surveyId, String testRefTable, String testRefId, String resultFiles,
