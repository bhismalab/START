package com.reading.start.tests.test_parent.ui.dialogs;
...
public class DialogCompleteTest extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View mRootView = inflater.inflate(R.layout.test_parent_dialog_completed_test, container);
        ...
        mRootView.findViewById(R.id.button_next).setVisibility(View.INVISIBLE);
        ...
        mRootView.findViewById(R.id.button_new).setVisibility(View.INVISIBLE);
