package com.reading.start.tests.test_parent.data.api;
...
public interface APISurveys {
    ...
    @GET("api/surveys/{survey_id}/results/parent_assestment")
    Call<ResponseDownloadSurveyResultData> getResult(@Header("X-Auth-Token") String token,
                                                     @Path("survey_id") String surveyId);

    @GET("api/surveys/{survey_id}/attachments/parent_assestment")
