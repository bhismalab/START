package com.reading.start.tests.test_choice_touching.ui.dialogs;
...
public class DialogCompleteTest extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View mRootView = inflater.inflate(R.layout.test_choice_touching_dialog_completed_test, container);
