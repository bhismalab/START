...
<section class="content-header">
	<h1>
		<?=CMS::t('menu_item_social_workers_edit');?>
		<small><?=utils::safeEcho(@$user['full_name'], 1);?></small>
	</h1>
</section>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="email" value="<?=utils::safePostValue('email', $user['email'], 1);?>" class="form-control" autocomplete="off" />
						</div>

						<div class="form-group">
							<label><?=CMS::t('social_workers_new_pwd');?></label>
...
// ]]>
						...
						<!--<div class="form-group">
							...
							<select name="gender" class="form-control">
								...
								<?php
/*									$current_gender = (isset($_POST['gender'])? @(string)$_POST['gender']: $user['gender']);
								*/?>
								<option value="M"<?/*=(($current_gender=='M')? ' selected="selected"': '');*/?>><?/*=CMS::t('social_workers_gender_male');*/?></option>
								<option value="F"<?/*=(($current_gender=='F')? ' selected="selected"': '');*/?>><?/*=CMS::t('social_workers_gender_female');*/?></option>
							</select>
						</div>-->
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="full_name" value="<?=utils::safePostValue('full_name', $user['full_name'], 1);?>" class="form-control" autocomplete="off" />
						</div>
						...
						<!--<div class="form-group">
							...
							<div class="input-group colorpicker-component" id="componentPickColor">
								...
								<input type="text" name="color" value="<?/*=utils::safePostValue('color', $user['color'], 1);*/?>" class="form-control" id="inpPickColor" />
							</div>
...
// ]]>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="birth_date" value="<?=utils::safePostValue('birth_date', utils::formatMySQLDate('d.m.Y', $user['birth_date']), 1);?>" placeholder="" class="form-control datepicker" />
							</div>
