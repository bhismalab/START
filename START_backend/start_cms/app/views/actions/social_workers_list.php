...
<form action="?controller=social_workers&amp;action=delete" method="post" id="formDeleteItem">
...
<section class="content-header">
	<h1>
		<?=CMS::t('menu_block_social_workers');?>
...
<section class="content">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><?=CMS::t('social_workers_list_details', [
				'{count}' => $count
			]);?></h3>

			<?php if (CMS::hasAccessTo('social_workers/add', 'write')) { ?>
			<a href="?controller=social_workers&amp;action=add&amp;return=<?=$link_return;?>&amp;<?=time();?>" class="btn btn-context"><i class="fa fa-plus-circle" aria-hidden="true"></i> Create new social worker</a>
			<?php } ?>

			<?php if (CMS::hasAccessTo('cms_users/list')) { ?>
			<a href="?controller=cms_users&amp;action=list" class="btn btn-context"><i class="fa fa-user" aria-hidden="true"></i> CMS users</a>
			<?php } ?>
			...
			<!-- <div class="box-tools pull-right col-sm-5 col-lg-6">
				<form action="" method="get" id="formSearchAndFilter">
					...
					<div class="input-group has-feedback" style="top: 6px;">
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					?>
						<tr>
							<td>
								<!-- <?=view::gravatar($user['email'], 40, [
									'class' => 'userpic img-circle img-bordered-sm',
							...
							<td>
								<a href="?controller=social_workers&amp;action=edit&amp;id=<?=$user['id'];?>&amp;return=<?=$link_return;?>&amp;<?=time();?>" title="">
									<?=utils::safeEcho($user['full_name'], 1);?>
								</a>
							</td>
							<td>
								<?php if (CMS::hasAccessTo('social_workers/ajax_set_ban', 'write')) { ?>
									<a href="?controller=social_workers&amp;action=ajax_set_ban" title="" class="aAjax btn-toggle" data-ajax_post="<?=utils::safeEcho(json_encode([
							...
							<td>
								<?php if (CMS::hasAccessTo('social_workers/edit', 'write')) { ?>
								<a href="?controller=social_workers&amp;action=edit&amp;id=<?=$user['id'];?>&amp;return=<?=$link_return;?>&amp;<?=time();?>" title="<?=CMS::t('edit');?>">
									<i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?=CMS::t('edit');?>
								</a>
								<?php } else if (CMS::hasAccessTo('social_workers/edit', 'read')) { ?>
								<a href="?controller=social_workers&amp;action=edit&amp;id=<?=$user['id'];?>&amp;return=<?=$link_return;?>&amp;<?=time();?>" title="<?=CMS::t('view');?>">
									<i class="fa fa-eye" aria-hidden="true"></i> <?=CMS::t('view');?>
								</a>
								<?php } ?>

								<?php if (CMS::hasAccessTo('social_workers/delete', 'write')) { ?>
								...
								<script type="text/javascript">
									$('#aDeleteItem_<?=$user['id'];?>').on('click', function() {
										bootbox.confirm({
											message: '<?=CMS::t('social_workers_delete_confirmation');?>',
