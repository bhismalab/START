				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="image-preview">
                                    ...
                                    <div class="image-preview-info">
                                        <p>
                                            ...
                                            <?=CMS::t('article_image_original_upload_datetime');?>: <?=($imgModTimestamp? date('d.m.Y', $imgModTimestamp): '-');?><br />
                                            <br />
                                            <br />
										</p>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if (!empty($exercise['slide'])) {
                                $uploadUrl = SITE.utils::dirCanonicalPath(CMS_DIR.UPLOADS_DIR);
                                $previewUrl = $uploadUrl.'tests_content/'.$exercise['slide'];
                                $preview_exists = is_file(UPLOADS_DIR.'tests_content/'.$exercise['slide']);
                                ?>
                                <div class="image-preview">
                                    <img src="<?=($preview_exists? $previewUrl: IMAGE_DIR.'noimg.jpg');?>" alt="<?=$exercise['slide'];?>" class="img-responsive image-preview-img" />
                                    <div class="image-preview-info">
                                        <p>
                                            <?php
                                            $orgSize = utils::getFileSizeFormatted(UPLOADS_DIR.'tests_content/'.$exercise['slide']);

                                            $tmbSize = utils::getFileSizeFormatted(UPLOADS_DIR.'tests_content/'.$exercise['slide']);
                                            $imgModTimestamp = @filemtime(UPLOADS_DIR.'tests_content/'.$exercise['slide']);
                                            ?>
