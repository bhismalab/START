				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="language" value="<?=utils::safeEcho(@$_POST['language'], 1);?>" class="form-control" autocomplete="off" />
						</div>

						<div class="form-group">
							<label>Language (hindi)</label>

							<input type="text" name="language_hindi" value="<?=utils::safeEcho(@$_POST['language_hindi'], 1);?>" class="form-control" autocomplete="off" />
						</div>
					</div>
				</div>
			</div>
