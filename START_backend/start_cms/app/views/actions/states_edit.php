				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="state" value="<?=utils::safeEcho(@$state['name'], 1);?>" class="form-control" autocomplete="off" />
						</div>

						<div class="form-group">
							<label>State (hindi)</label>

							<input type="text" name="state_hindi" value="<?=utils::safeEcho(@$state['name_hindi'], 1);?>" class="form-control" autocomplete="off" />
						</div>
					</div>
				</div>
			</div>
